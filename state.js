...
var state = {
  ...
  plannerView: 'list',
  kanbanColumns: JSON.parse(localStorage.getItem('kanbanColumns') || '["To Do", "In Progress", "Done"]'),
  projectBudgets: JSON.parse(localStorage.getItem('projectBudgets') || '[]'),
  meetings: JSON.parse(localStorage.getItem('meetings') || '[]'),
  calendarConfig: JSON.parse(localStorage.getItem('calendarConfig') || '{"syncEnabled": false, "calendarId": null}'),
